...
const HeaderDark = () => {
  ...
  const LARGE_DEVICE_CONTENT = (
    <FlexBox component="nav" sx={LIST_STYLE}>
      ...
      <Box component={Link} href="http://essence-doc.vercel.app/" color="white">
        Documentation
      </Box>
        ...
        <Scrollbar>
          ...
          >
            ...
            <ListItem disablePadding>
              <ListItemButton
                LinkComponent="a"
                href="http://essence-doc.vercel.app/"
              >
                Documentation
              </ListItemButton>
            </ListItem>
  ...
  return (
    <FlexBetween component="header" py={2}>
      ...
      <Box
        ...
        gap={0.5}
      >
        <img src="/static/logo/logo.png" alt="logo" width={40} height={40} />
